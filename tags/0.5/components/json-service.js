 ...
 *
 * The modified code has been further modified to support application/json pretty printing
...
/* application/json -> text/html stream converter */
...
JSONStreamConverter.prototype = {
  ...
  init: function() {
    if (this._initialized)
        return
    this._logger = Components.classes["@mozilla.org/consoleservice;1"].getService(Components.interfaces.nsIConsoleService)
    this._logger.logStringMessage("JSONStreamConvert initialized")
    if (typeof(JSON) == 'undefined') {
      // for Firefox up to 3.1
      try {
        Components.utils.import("resource://jsonovich/json2.jsm")
        this.JSON = JSON2
      } catch (e) {
